...
=================================================================================================
This program demonstrates how rainfall and temperature data can be used to predict maize Yield
...
def validate_dataset(df: pd.DataFrame) -> None:
    ...
    if df["Yield"].isna().all():
        raise ValueError("Yield column contains no value")


def create_correlation_metrix(df: pd.DataFrame) -> None:
...
def main() -> None:
    ...
    try:
        ...
        print("\n------------------------------------------------------------")
        print("MAIZE YIELD PREDICTIONS RESULTS")
        print("-------------------------------------------------------------")
